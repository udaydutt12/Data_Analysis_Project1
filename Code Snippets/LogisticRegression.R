...
# For logistic regression, we change price to either Low or high. 
# First, we normalized the prices to be in between 0 and 1.
#  Then, we made above a 0.5=High, and less than a 0.5=Low.

# The probability of accurately predicting internet usage level was only 23.33%. 
# The probability value are relatively low, as the data is not that strongly related.
