...
# This plot is shows that it is possible to obtain a model using 7 variables.
# It is weird that this shows 7 variables, but we were not able to take away 
# any variables when doing best subset selection.
