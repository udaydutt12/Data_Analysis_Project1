...
# Stepwise selection was not able to change the initial model. Hence, 
# the initial model that contains all of the variables is the best model
# according to stepwise selection.
